...
use Dudulina\CodeGeneration\Query\QueryAskersMapCodeGenerator;
use Dudulina\CodeGeneration\Query\QueryAskersMapTemplate;
...
$writer = new \Dudulina\CodeGeneration\CodeWriter(
    new QueryAskersMapCodeGenerator(),
    QueryAskersMapTemplate::class,
    'QueryAskersMap'
);
