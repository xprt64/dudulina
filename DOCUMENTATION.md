...
There is possibility that more than one command handler exists for a Command. __This must be avoided__.
In order to minimize this risk, a tool was created: `CommandValidatorsMapCodeGenerator`.
This tool should be run after any command handlers map regeneration.
